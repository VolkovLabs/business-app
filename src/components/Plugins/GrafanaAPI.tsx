 ...
 * Grafana HTTP API
 */
export class GrafanaAPI extends PureComponent {
  render() {
    return (
      <Card>
        <Card.Heading>Grafana HTTP API Data Source</Card.Heading>
        <Card.Description>
          Allows retrieving data from local and remote Grafana instances via HTTP API.
        </Card.Description>
        <Card.Figure>
          <a
            target="_blank"
        ...
        <Card.Actions>
          ...
          <LinkButton
            ...
            icon="play"
            target="_blank"
            href="https://www.youtube.com/playlist?list=PLPow72ygztmSIGUYFVhZ-pJQnYw_LN4KU"
          >
            YouTube
          </LinkButton>
          <LinkButton
